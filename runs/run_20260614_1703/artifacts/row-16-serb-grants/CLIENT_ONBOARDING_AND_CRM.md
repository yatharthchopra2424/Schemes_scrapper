...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Fellowships (monthly stipend and research grant)
  - Travel grants for national and international collaboration
  - Equipment funding
  - Access to research networks
  - Recognition through prestigious fellowships
  - Opportunities for national and international collaboration
  - Support for publishing research outcomes
...
|---|---|---|---|
| Curriculum Vitae (CV) | | | Critical |
| List of publications | | | Critical |
| Project proposal with objectives and methodology | | | Critical |
| Detailed budget breakdown | | | Critical |
| Institutional endorsement letter | | | Critical |
| Proof of Ph.D. degree (if applicable) | | | Critical |
| Endorsement from host institution | | | Critical |
| Ethics clearance (if applicable) | | | Optional |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: SERB Grants
...
| 02 - Qualified | Eligibility confirmed for SERB Grants | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://serbonline.in/ | Internal review |
| 06 - Submitted | Application filed on https://serbonline.in/ | Begin follow-up |
| 07 - Under review | With Science and Engineering Research Board (SERB), Department of Science and Technology (DST), Ministry of Science and Technology | Monitor + respond to queries |
