...
preparation, and submission support for IN-SPACe Seed Fund administered by
...
Approval is at the sole discretion of Indian National Space Promotion and Authorization Centre (IN-SPACe).
...
applications submitted to Indian National Space Promotion and Authorization Centre (IN-SPACe).
...
IN-SPACe Seed Fund application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for IN-SPACe Seed Fund. Eligibility is subject to final verification by
   Indian National Space Promotion and Authorization Centre (IN-SPACe)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for IN-SPACe Seed Fund
   are subject to change by Indian National Space Promotion and Authorization Centre (IN-SPACe) without notice. We recommend
   verifying current guidelines at https://www.inspaceindia.org/ before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under IN-SPACe Seed Fund."
...
"All documents submitted to Indian National Space Promotion and Authorization Centre (IN-SPACe) under IN-SPACe Seed Fund
