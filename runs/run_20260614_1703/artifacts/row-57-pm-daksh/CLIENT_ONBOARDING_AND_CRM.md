...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Free skill development training in IT, healthcare, hospitality, construction, or textiles
  - Provision of free course material during training
  - Stipend during training (where applicable)
  - Post-training placement assistance or support for self-employment
  - Nationally recognized certificate upon completion (aligned with NSQF)
...
|---|---|---|---|
| Caste Certificate (SC/OBC/DNT as applicable) | | | Critical |
| Identity Proof (Aadhaar Card, Voter ID, PAN, etc.) | | | Critical |
| Address Proof (Aadhaar, utility bill, ration card) | | | Critical |
| Age Proof (Birth Certificate, School Leaving Certificate) | | | Critical |
| Passport-sized Photographs | | | Critical |
| Mobile Number and Email ID for communication | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: PM-DAKSH
- Engagement start date:
- Expected application date: (note deadlines from evidence) Rolling basis — applications are accepted throughout the year subject to availability of training slots.
...
| 02 - Qualified | Eligibility confirmed for PM-DAKSH | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://pmdaksh.dosje.gov.in | Internal review |
| 06 - Submitted | Application filed on https://pmdaksh.dosje.gov.in | Begin follow-up |
