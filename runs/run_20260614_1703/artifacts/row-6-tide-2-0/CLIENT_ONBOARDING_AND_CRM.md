...
- Incubators must be from institutions of higher learning and R&D organisations having incubation facilities and established linkages with large companies, industry bodies, industry clusters.

### Needs Assessment
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Entrepreneurs-in-residence (EiR) support: upto Rs. 4 Lakh for idea to Proof of Concept
  - Grant support: upto Rs. 7 Lakh for prototype development
  - Investment support: upto Rs. 40 Lakh for product development and market outreach
  - Handholding and mentorship for tech startups
  - Access to MeitY Startup Hub ecosystem and networking opportunities
  - IPR protection and commercialization support
...
|---|---|---|---|
| MoU executed by Implementing Agencies/Partnering Institutes | | | Critical |
| Surety Bond by Implementing Agencies | | | Critical |
| Utilization Certificate of Previous release | | | Critical |
| Technical & Financial Progress Report | | | Critical |
| Audited statement of accounts | | | Critical |
| Recommendations of the PRSG | | | Critical |
...
- Expected application date: (note deadlines from evidence)
  - Scheme implemented from 01 February, 2019 to 31st January, 2024 (60 months duration). Applications must be submitted within this period.
...
| 05 - In preparation | Drafting application on https://msh.meity.gov.in/schemes/tide | Internal review |
| 06 - Submitted | Application filed on https://msh.meity.gov.in/schemes/tide | Begin follow-up |
| 07 - Under review | With Innovation and IPR Division, MeitY in association with 51 incubation centres from institutes of higher learning and R&D organisations | Monitor + respond to queries |
