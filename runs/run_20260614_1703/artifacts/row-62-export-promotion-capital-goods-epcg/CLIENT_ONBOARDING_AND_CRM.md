...
- IEC (Importer Exporter Code) is mandatory for EPCG scheme eligibility.

### Needs Assessment
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Zero customs duty on import of capital goods for pre-production, production, and post-production
  - Exemption from IGST and Compensation Cess on capital goods imported for physical exports (available up to 31.03.2020)
  - Ability to procure capital goods from domestic market per paragraph 5.07 of FTP
...
|---|---|---|---|
| IEC (Importer Exporter Code) |  |  | Critical – Mandatory prerequisite for EPCG application |
| ANF-5A application form |  |  | Critical – Primary application form for EPCG scheme |
| Documents as per Chapter 5 of Foreign Trade Policy and Handbook of Procedures |  |  | Critical – Referenced as required pre-requisites; specific documents depend on applicant category and capital goods type |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Export Promotion Capital Goods (EPCG)
...
| 02 - Qualified | Eligibility confirmed for Export Promotion Capital Goods (EPCG) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://dgft.gov.in/CP/?opt=epcg | Internal review |
| 06 - Submitted | Application filed on https://dgft.gov.in/CP/?opt=epcg | Begin follow-up |
| 07 - Under review | With Directorate General of Foreign Trade (DGFT), Ministry of Commerce and Industry | Monitor + respond to queries |
