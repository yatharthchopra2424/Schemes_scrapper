...
preparation, and submission support for SIDBI SMILE Scheme administered by
...
SIDBI SMILE Scheme application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for SIDBI SMILE Scheme. Eligibility is subject to final verification by
   Small Industries Development Bank of India (SIDBI)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for SIDBI SMILE Scheme
   are subject to change by Small Industries Development Bank of India (SIDBI) without notice. We recommend
   verifying current guidelines at https://sidbi.in/smile before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under SIDBI SMILE Scheme."
...
"All documents submitted to Small Industries Development Bank of India (SIDBI) under SIDBI SMILE Scheme
