...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - [ ] Access to angel investment network
...
| Bank Statements (Last 6 Months) | | | Critical |
| Detailed Project Report (DPR) | | | Critical |
| Technology/IP Documentation | | | Optional |
| Founder/Team CVs | | | Optional |
| Letters of Intent / MoUs (if any) | | | Optional |
| Shareholding Pattern | | | Critical |
...
- Target schemes: BIRAC BioAngels Network
...
| 02 - Qualified | Eligibility confirmed for BIRAC BioAngels Network | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://birac.nic.in/bioangels.php | Internal review |
| 06 - Submitted | Application filed on https://birac.nic.in/bioangels.php | Begin follow-up |
| 07 - Under review | With BIRAC (Biotechnology Industry Research Assistance Council) | Monitor + respond to queries |
