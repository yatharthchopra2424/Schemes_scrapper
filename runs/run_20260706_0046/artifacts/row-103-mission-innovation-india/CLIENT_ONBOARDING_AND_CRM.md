...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Financial support for R&D and pilot projects
  - Access to testing and validation facilities
...
|---|---|---|---|
| Project proposal detailing objectives, methodology, and expected outcomes | | | Critical |
| Budget breakdown and justification | | | Critical |
| Technical feasibility report | | | Critical |
| Information on applicant organization (registration, PAN, etc.) | | | Critical |
| Details of collaborating partners (if any) | | | Optional |
| Intellectual property status and management plan | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Mission Innovation India
...
| 02 - Qualified | Eligibility confirmed for Mission Innovation India | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on [https://dst.gov.in/mission-innovation-india](https://dst.gov.in/mission-innovation-india) | Internal review |
| 06 - Submitted | Application filed on [https://dst.gov.in/mission-innovation-india](https://dst.gov.in/mission-innovation-india) | Begin follow-up |
| 07 - Under review | With Department of India | Monitor + respond to queries |
