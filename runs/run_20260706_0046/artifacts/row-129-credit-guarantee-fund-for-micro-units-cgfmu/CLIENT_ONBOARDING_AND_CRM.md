...
- Registration with NCGTC as an Eligible Lending Institution (ELI) is required for CGFMU.
- Required documents: Signed and stamped undertaking, Board Resolution.

### Needs Assessment
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Collateral-free loan access for micro units
  - Guarantee coverage reducing lending risk for financial institutions
  - Inclusion of PMJDY overdraft loans up to Rs.10,000
  - Enhanced credit accessibility for underserved micro enterprises
...
|---|---|---|---|
| Signed and stamped undertaking |  |  | Critical |
| Board Resolution |  |  | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Credit Guarantee Fund for Micro Units (CGFMU)
...
| 02 - Qualified | Eligibility confirmed for Credit Guarantee Fund for Micro Units (CGFMU) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://www.ncgtc.in | Internal review |
| 06 - Submitted | Application filed on https://www.ncgtc.in | Begin follow-up |
| 07 - Under review | With National Credit Guarantee Trustee Company Ltd (NCGTC) | Monitor + respond to queries |
