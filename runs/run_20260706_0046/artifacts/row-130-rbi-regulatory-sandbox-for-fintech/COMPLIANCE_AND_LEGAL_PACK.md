...
preparation, and submission support for RBI Regulatory Sandbox for Fintech administered by
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for RBI Regulatory Sandbox for Fintech. Eligibility is subject to final verification by
   Reserve Bank of India."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for RBI Regulatory Sandbox for Fintech
   are subject to change by Reserve Bank of India without notice. We recommend
   verifying current guidelines at https://www.rbi.org.in/Scripts/bs_viewcontent.aspx?Id=3854 before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under RBI Regulatory Sandbox for Fintech."
...
"All documents submitted to Reserve Bank of India under RBI Regulatory Sandbox for Fintech
