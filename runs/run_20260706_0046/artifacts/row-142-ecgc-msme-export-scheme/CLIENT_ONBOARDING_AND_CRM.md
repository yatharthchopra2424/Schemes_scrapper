...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Financial compensation for export losses due to buyer default
  - Quick claim settlement process
  - Access to ECGC’s digital portal for claim submission and tracking
  - Support under the government-backed RELIEF initiative
  - Assistance in recovering dues from insolvent or defaulting overseas buyers
...
|---|---|---|---|
| Export invoice | | | Critical |
| Shipping bill | | | Critical |
| Proof of export (bill of lading, airway bill) | | | Critical |
| Proof of non-payment by buyer | | | Critical |
| Buyer insolvency or bankruptcy certificate | | | Critical |
| ECGC policy copy | | | Critical |
| Claim form as per RELIEF scheme | | | Critical |
| Bank account details for settlement | | | Critical |
| Authorization letter from exporter | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: ECGC MSME Export Scheme
...
| 02 - Qualified | Eligibility confirmed for ECGC MSME Export Scheme | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://www.ecgcltd.in | Internal review |
| 06 - Submitted | Application filed on https://www.ecgcltd.in | Begin follow-up |
| 07 - Under review | With Export Credit Guarantee Corporation of India (ECGC), Ministry of Commerce and Industry, Government of India | Monitor + respond to queries |
