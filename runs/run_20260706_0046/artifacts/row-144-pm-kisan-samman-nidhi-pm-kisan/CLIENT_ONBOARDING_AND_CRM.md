...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Direct income support of Rs. 6000 per annum per family
  - Three equal installments of Rs. 2000 every four months
  - Direct Benefit Transfer (DBT) into Aadhaar-seeded bank account
  - Financial support for agricultural inputs and domestic needs
  - Protection from moneylenders
  - Continuance in farming activities
...
|---|---|---|---|
| Name, Age, Gender, Category (SC/ST) | | | Critical |
| Aadhaar Number (or Aadhaar Enrollment Number in Assam, Meghalaya, J&K till 31.03.2020) | | | Critical |
| Alternate identity documents (Driving Licence, Voter ID Card, NREGA Job Card, etc.) where Aadhaar not available | | | Optional (for first installment in certain States/UTs) |
| Bank Account Number | | | Critical |
| IFSC Code | | | Critical |
| Mobile Number (advised but not mandatory) | | | Optional |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: PM Kisan Samman Nidhi (PM-KISAN)
- Engagement start date:
- Expected application date: (note deadlines from evidence) Rolling basis — no fixed deadline. Applications are accepted year-round based on State/UT submission of beneficiary lists.
...
| 02 - Qualified | Eligibility confirmed for PM Kisan Samman Nidhi (PM-KISAN) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on http://pmkisan.gov.in | Internal review |
| 06 - Submitted | Application filed on http://pmkisan.gov.in | Begin follow-up |
| 07 - Under review | With Department of Agriculture, Cooperation & Farmers Welfare (DAC&FW), Ministry of Agriculture & Farmers’ Welfare | Monitor + respond to queries |
