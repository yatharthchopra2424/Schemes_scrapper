...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Working capital for post-harvest storage
  - Marketing of agricultural produce
  - Consumption needs of farmer household
  - Investment in allied activities (dairy, fisheries, poultry, etc.)
...
|---|---|---|---|
| Land ownership/tenancy documents | [ ] | | Critical |
| Identity proof (Aadhaar/Voter ID/PAN) | [ ] | | Critical |
| Passport size photographs | [ ] | | Critical |
| Crop loan application form | [ ] | Critical | Available at bank branch or portal |
| Kisan Credit Card application form | [ ] | Critical | Available at bank branch or portal |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Kisan Credit Card (KCC) for Farmers ]
...
| 02 - Qualified | Eligibility confirmed for [Kisan Credit Card (KCC) for Farmers] | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on [https://nabard.org/auth/writereaddata/tender/1806180417Revised%20KCC%20guidelines.pdf] | Internal review |
| 06 - Submitted | Application filed on [https://nabard.org/auth/writereaddata/tender/1806180417Revised%20KCC%20guidelines.pdf] | Begin follow-up |
| 07 - Under review | With [NABARD] | Monitor + respond to queries |
