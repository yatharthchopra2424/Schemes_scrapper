...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Timely and affordable credit support
  - Access to short-term loans for crop production, allied activities, and household requirements
  - Credit card linked to bank account for flexible withdrawal of funds as needed
...
| Proof of identity | [ ] | [ ] | Critical |
| Proof of address | [ ] | [ ] | Critical |
| Land ownership or lease documents (for crop farmers) | [ ] | [ ] | Critical for crop farmers; optional for fishers/livestock farmers |
| Details of fisheries or animal husbandry activities | [ ] | [ ] | Critical |
| Bank account details | [ ] | [ ] | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Kisan Credit Card for Fisheries & Animal Husbandry
...
| 02 - Qualified | Eligibility confirmed for Kisan Credit Card for Fisheries & Animal Husbandry | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://dof.gov.in/offerings | Internal review |
| 06 - Submitted | Application filed on https://dof.gov.in/offerings | Begin follow-up |
| 07 - Under review | With Department of Fisheries, Ministry of Fisheries, Animal Husbandry and Dairying | Monitor + respond to queries |
