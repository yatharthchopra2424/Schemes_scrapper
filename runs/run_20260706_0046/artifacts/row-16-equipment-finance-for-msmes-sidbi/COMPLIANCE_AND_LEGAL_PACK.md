...
preparation, and submission support for Equipment Finance for MSMEs (SIDBI) administered by
...
This NDA covers all materials submitted as part of the Equipment Finance for MSMEs (SIDBI) application process.
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Equipment Finance for MSMEs (SIDBI). Eligibility is subject to final verification by
   Small Industries Development Bank of India (SIDBI)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Equipment Finance for MSMEs (SIDBI)
   are subject to change by Small Industries Development Bank of India (SIDBI) without notice. We recommend
   verifying current guidelines at https://sidbi.in/machinery-loan before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Equipment Finance for MSMEs (SIDBI)."
...
"All documents submitted to Small Industries Development Bank of India (SIDBI) under Equipment Finance for MSMEs (SIDBI)
