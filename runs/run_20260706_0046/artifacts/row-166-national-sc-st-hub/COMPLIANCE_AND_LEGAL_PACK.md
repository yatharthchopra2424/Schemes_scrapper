...
preparation, and submission support for National SC/ST Hub administered by
National Small Industries Corporation (NSIC), a public-sector undertaking under the administrative control of the Ministry of MSME.
...
Approval is at the sole discretion of National Small Industries Corporation (NSIC).
...
applications submitted to National Small Industries Corporation (NSIC).
...
National SC/ST Hub application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for National SC/ST Hub. Eligibility is subject to final verification by
   National Small Industries Corporation (NSIC)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for National SC/ST Hub
   are subject to change by National Small Industries Corporation (NSIC) without notice. We recommend
   verifying current guidelines at https://scsthub.in before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under National SC/ST Hub."
...
"All documents submitted to National Small Industries Corporation (NSIC) under National SC/ST Hub
