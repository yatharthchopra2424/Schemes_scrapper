...
preparation, and submission support for Digital MSME Scheme administered by
...
Approval is at the sole discretion of Ministry of Micro, Small and Medium Enterprises (MoMSME).
...
applications submitted to Ministry of Micro, Small and Medium Enterprises (MoMSME).
...
Digital MSME Scheme application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Digital MSME Scheme. Eligibility is subject to final verification by
   Ministry of Micro, Small and Medium Enterprises (MoMSME)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Digital MSME Scheme
   are subject to change by Ministry of Micro, Small and Medium Enterprises (MoMSME) without notice. We recommend
   verifying current guidelines at https://digital.msme.gov.in before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Digital MSME Scheme."
...
"All documents submitted to Ministry of Micro, Small and Medium Enterprises (MoMSME) under Digital MSME Scheme
