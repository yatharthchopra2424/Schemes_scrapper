...
This NDA covers all materials submitted as part of the [Integrated Processing Development Scheme (IPDS)] application process.
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for [Integrated Processing Development Scheme (IPDS)]. Eligibility is subject to final verification by
   [implementing agency from evidence]."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for [Integrated Processing Development Scheme (IPDS)]
...
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under [Integrated Processing Development Scheme (IPDS)]."
...
All documents submitted to [implementing agency from evidence] under [Integrated Processing Development Scheme (IPDS)]
