...
- **Required registrations for MeitY Startup Hub (MSH):** Certificate of Incorporation, PAN of the entity
...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Investor connect (venture capital/angel investors)
  - Prototype development support
  - Testing and certification support
  - Guidance on regulatory compliance
  - Access to government grants and seed funding
...
| Business plan or project proposal | | | Critical |
| Details of technology or innovation focus | | | Critical |
| PAN of the entity | | | Critical |
| Authorization letter from authorized signatory | | | Critical |
| Details of any existing funding or support received | | | Optional |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: MeitY Startup Hub (MSH)
...
| 02 - Qualified | Eligibility confirmed for MeitY Startup Hub (MSH) | Send proposal |
