...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Revenue generation through user fees at Public Data Offices (PDOs)
  - Revenue-sharing opportunities for PDO owners
  - Digital inclusion by expanding internet access in underserved areas
  - Growth of a distributed Wi-Fi ecosystem across India
  - Centralized authentication and billing system through PDO aggregators
  - Easy setup and operation of Wi-Fi hotspots without individual licensing for each access point
...
| Technical details of Wi-Fi equipment to be deployed | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: PM-WANI (WiFi Access Network Interface)
...
| 02 - Qualified | Eligibility confirmed for PM-WANI (WiFi Access Network Interface) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://dot.gov.in/pm-wani | Internal review |
| 06 - Submitted | Application filed on https://dot.gov.in/pm-wani | Begin follow-up |
