...
in the "Services: Keep the "No guarantee clause" verbatim — government approval is always
...
and submission support for Standards & Labelling Programme (BEE) administered by Bureau of Energy Efficiency (BEE), Ministry of Power, Govt. of India.

**Fees:** As per the attached proposal. Retainer is payable upfront. Success fee is payable on sanction.

**No guarantee clause:** Consultant makes no guarantee clause: Consultant makes no representation that any scheme will be approved.
