...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Police assistance (FIR filing, NCR recording)
  - Legal aid and counselling
  - Psycho-social counselling
  - Temporary shelter (up to 5 days)
  - Video conferencing facility for court proceedings
  - Referral linkages to skill training, employment, and long-term rehabilitation
...
|---|---|---|---|
| No documents are mandatory for availing services at the One Stop Centre | N/A | N/A | Services are accessible without any precondition of documentation |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: One Stop Centre Scheme (Sakhi)
- Engagement start date:
- Expected application date: Services are available 24x7, 365 days a year on a walk-in basis (no fixed deadline)
...
|  call |
| 02 - Qualified | Eligibility confirmed for One Stop Centre Scheme (Sakhi) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on [No specific portal - walk-in based service] | Internal review |
| 06 - Submitted | Application filed on [No specific portal - walk-in based service] | Begin follow-up |
| 07 - Under review | With Ministry of Women and Child Development | Monitor + respond to queries |
