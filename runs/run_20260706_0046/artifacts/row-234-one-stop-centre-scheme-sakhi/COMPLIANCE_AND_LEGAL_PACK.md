...
preparation, and submission support for One Stop Centre Scheme (Sakhi) administered by
...
One Stop Centre Scheme (Sakhi) application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for One Stop Centre Scheme (Sakhi). Eligibility is subject to final verification by
   Ministry of Women and Child Development."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for One Stop Centre Scheme (Sakhi)
...
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under One Stop Centre Scheme (Sakhi)."
...
"All documents submitted to Ministry of Women and Child Development under One Stop Centre Scheme (Sakhi)
