...
preparation, and submission support for Multimodal Logistics Park (MMLP) Scheme administered by
...
Approval is at the sole discretion of National Highways & Infrastructure Development Corporation Limited (NHIDCL).
...
applications submitted to National Highways & Infrastructure Development Corporation Limited (NHIDCL).
...
Multimodal Logistics Park (MMLP) Scheme application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Multimodal Logistics Park (MMLP) Scheme. Eligibility is subject to final verification by
   National Highways & Infrastructure Development Corporation Limited (NHIDCL)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Multimodal Logistics Park (MMLP) Scheme
   are subject to change by National Highways & Infrastructure Development Corporation Limited (NHIDCL) without notice. We recommend
   verifying current guidelines at https://nhidcl.com before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Multimodal Logistics Park (MMLP) Scheme."
...
"All documents submitted to National Highways & Infrastructure Development Corporation Limited (NHIDCL) under Multimodal Logistics Park (MMLP) Scheme must be retained for a minimum of 3 years for audit purposes."