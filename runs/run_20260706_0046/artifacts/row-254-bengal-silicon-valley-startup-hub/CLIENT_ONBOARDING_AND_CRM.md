...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Access to incubation infrastructure
  - Mentorship from industry experts
  - Networking opportunities
  - Shared office facilities
  - Support services for startup growth and scaling
...
|---|---|---|---|
| Certificate of Incorporation / Registration | | | Critical – Proof of legal entity registration |
| Project proposal or business plan | | | Critical – Must detail innovative idea or technology-based solution |
| PAN of the entity | | | Critical – Required for entity identification |
| Proof of registration in West Bengal | | | Critical – Must demonstrate West Bengal registration |
| Details of founders and team | | | Critical – Required for applicant assessment |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Bengal Silicon Valley Startup Hub
- Engagement start date:
- Expected application date: (note deadlines from evidence) – Rolling basis; apply as soon as documentation is complete
...
| 02 - Qualified | Eligibility confirmed for Bengal Silicon Valley Startup Hub | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://wbsidco.gov.in | Internal review |
| 06 - Submitted | Application filed on https://wbsidco.gov.in | Begin follow-up |
| 07 - Under review | With West Bengal Small Industries Development Corporation Limited (WBSIDCO) | Monitor + respond to queries |
