...
- Startup registered in Jharkhand or willing to establish operations in Jharkhand (mandatory per eligibility criteria)
...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Facilitation in regulatory clearances
  - Support for prototype development and market validation
  - Seed funding, grants, and incentives (as per policy provisions)
...
|---|---|---|---|
| Certificate of Incorporation / Registration |  |  | Critical - Proof of entity registration |
| PAN of the entity |  |  | Critical - Tax identification |
| Business plan or pitch deck |  |  | Critical - Required for evaluation of innovation and scalability |
| Proof of innovation or prototype |  |  | Critical - Evidence of innovative idea/product/service |
| Bank account details |  |  | Critical - For potential fund disbursement |
| Authorized signatory details |  |  | Critical - For application submission and correspondence |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Jharkhand Startup Policy
- Engagement start date:
- Expected application date: (note deadlines from evidence) - Applications accepted on an ongoing basis per policy; no fixed deadline specified in evidence
...
| 02 - Qualified | Eligibility confirmed for Jharkhand Startup Policy | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://jharkhand.gov.in/Home/DocumentList?doctype=45c48cce2e2d7fbdea1afc51c7c6ad26&subdoctype=02e74f10e0327ad868d138f2b4fdd6f0 | Internal review |
| 06 - Submitted | Application filed on https://jharkhand.gov.in/Home/DocumentList?doctype=45c48cce2e2d7fbdea1afc51c7c6ad26&subdoctype=02e74f10e0327ad868d138f2b4fdd6f0 | Begin follow-up |
| 07 - Under review | With Department of Information Technology & e-Governance, Government of Jharkhand | Monitor + respond to queries |
