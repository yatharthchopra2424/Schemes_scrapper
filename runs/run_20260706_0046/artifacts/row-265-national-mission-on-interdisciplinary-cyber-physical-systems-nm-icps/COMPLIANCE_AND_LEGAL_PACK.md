...
preparation, and submission support for National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS) administered by
...
Approval is at the sole discretion of Department of Science and Technology (DST).
...
applications submitted to Department of Science and Technology (DST).
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS). Eligibility is subject to final verification by
   Department of Science and Technology (DST)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS)
   are subject to change by Department of Science and Technology (DST) without notice. We recommend
   verifying current guidelines at https://rdifund.anrf.gov.in/ before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS)."
...
"All documents submitted to Department of Science and Technology (DST) under National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS)
