...
- DPIIT recognition is required for eligibility under the SIDBI Startup Mitra – Incubation Portal scheme.
...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Assistance in market access and regulatory compliance
...
| Details of funding received (if any) of funding received | | | Optional |
| Authorized signatory authorization letter | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED (if any) | | | Optional |
| Authorized signatory authorization letter | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: SIDBI Startup Mitra – Incubation Portal
...
| 02 - Qualified | Eligibility confirmed for SIDBI Startup Mitra – Incubation Portal | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://www.startupindia.gov.in/content/sih/en/startupgov/startup-mitra.html | Internal review |
| 06 - Submitted | Application filed on https://www.startupindia.gov.in/content/sih/en/startupgov/startup-mitra.html | Begin follow-up |
