...
preparation, and submission support for AVGC-XR Policy (Animation, VFX, Gaming, Comics) administered by
...
This NDA covers all materials submitted as part of the AVGC-XR Policy (Animation, VFX, Gaming, Comics) application process.
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for AVGC-XR Policy (Animation, VFX, Gaming, Comics). Eligibility is subject to final verification by
   Ministry of Electronics and Information Technology (MeitY), Government of India."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for AVGC-XR Policy (Animation, VFX, Gaming, Comics)
   ...
   verifying current guidelines at https://www.meity.gov.in/avgc before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under AVGC-XR Policy (Animation, VFX, Gaming, Comics)."
...
"All documents submitted to Ministry of Electronics and Information Technology (MeitY), Government of India under AVGC-XR Policy (Animation, VFX, Gaming, Comics) must be retained for a minimum of 3 years for audit purposes."