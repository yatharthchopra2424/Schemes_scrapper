...
preparation, and submission support for Export Promotion for Handicrafts (EPCH) administered by
...
Approval is at the sole discretion of Export Promotion Council for Handicrafts (EPCH).
...
applications submitted to Export Promotion Council for Handicrafts (EPCH).
...
Export Promotion for Handicrafts (EPCH) application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Export Promotion for Handicrafts (EPCH). Eligibility is subject to final verification by
   Export Promotion Council for Handicrafts (EPCH)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Export Promotion for Handicrafts (EPCH)
   are subject to change by Export Promotion Council for Handicrafts (EPCH) without notice. We recommend
   verifying current guidelines at https://epch.in/apply-new-membership before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Export Promotion for Handicrafts (EPCH)."
...
"All documents submitted to Export Promotion Council for Handicrafts (EPCH) under Export Promotion for Handicrafts (EPCH)
