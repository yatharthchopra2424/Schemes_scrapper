...
preparation, and submission support for Telecom Technology Development Fund (TTDF) administered by
...
Approval is at the sole discretion of Department of Telecommunications, Ministry of Communications, Government of India.
...
applications submitted to Department of Telecommunications, Ministry of Communications, Government of India.
...
Telecom Technology Development Fund (TTDF) application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Telecom Technology Development Fund (TTDF). Eligibility is subject to final verification by
   Department of Telecommunications, Ministry of Communications, Government of India."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Telecom Technology Development Fund (TTDF)
   are subject to change by Department of Telecommunications, Ministry of Communications, Government of India without notice. We recommend
   verifying current guidelines at https://dot.gov.in/ttdf before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Telecom Technology Development Fund (TTDF)."
...
"All documents submitted to Department of Telecommunications, Ministry of Communications, Government of India under Telecom Technology Development Fund (TTDF) must be retained for a minimum of 3 years for audit purposes."