...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Access to 5G testbed infrastructure
  - Technical mentorship
  - Connectivity support
  - Validation facilities
  - Financial support for prototype development and testing
...
| Detailed project proposal |  |  | Critical |
| Technical specifications of the 5G use case |  |  | Critical |
| Team credentials and expertise |  |  | Critical |
| Budget utilization plan |  |  | Critical |
| Any relevant certifications or approvals |  |  | Optional |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: 5G Use Case Labs & Testbeds Initiative
...
| 02 - Qualified | Eligibility confirmed for 5G Use Case Labs & Testbeds Initiative | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://dot.gov.in/5g | Internal review |
| 06 - Submitted | Application filed on https://dot.gov.in/5g | Begin follow-up |
