...
preparation, and submission support for 5G Use Case Labs & Testbeds Initiative administered by
...
5G Use Case Labs & Testbeds Initiative application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for 5G Use Case Labs & Testbeds Initiative. Eligibility is subject to final verification by
   Department of Telecommunications, Ministry of Communications."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for 5G Use Case Labs & Testbeds Initiative
   are subject to change by Department of Telecommunications, Ministry of Communications without notice. We recommend
   verifying current guidelines at https://dot.gov.in/5g before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under 5G Use Case Labs & Testbeds Initiative."
...
"All documents submitted to Department of Telecommunications, Ministry of Communications under 5G Use Case Labs & Testbeds Initiative must be retained for a minimum of [3 years / as per scheme guidelines from evidence] for audit purposes."