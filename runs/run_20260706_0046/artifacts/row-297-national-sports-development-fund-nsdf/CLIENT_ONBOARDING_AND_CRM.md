...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Financial assistance for participation in national competitions
  - Financial assistance for participation in international competitions
  - Financial assistance for exposure trips
  - Financial assistance for sports science support
  - Facilitation of access to training facilities
  - Coordination with sports authorities
  - Support for career development of athletes
...
| Recommendation letter from National Sports Federation or State Sports Council | | | Critical |
| Details of training/competition plan | | | Critical |
| Budget estimate for the proposed activity | | | Critical |  |  |  |
| Past performance records of the athlete/coach/institution | | | Critical |
| Bank account details for fund transfer | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: National Sports Development Fund (NSDF)
- Engagement start date:
- Expected application date: (note deadlines from evidence) Rolling basis — applications can be submitted throughout the year as per the needs of athletes and institutions.
...
| 02 - Qualified | Eligibility confirmed for National Sports Development Fund (NSDF) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on [https://yas.nic.in/nsdf] | Internal review |
| 06 - Submitted | Application filed on [https://yas.nic.in/nsdf] | Begin follow-up |
| 07 - Under review | With [Ministry of Youth Affairs and Sports] | Monitor + respond to queries |
