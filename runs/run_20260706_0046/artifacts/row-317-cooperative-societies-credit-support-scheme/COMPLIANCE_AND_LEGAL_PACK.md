...
preparation, and submission support for Cooperative Societies Credit Support Scheme administered by
...
Approval is at the sole discretion of National Cooperative Development Corporation (NCDC).
...
applications submitted to National Cooperative Development Corporation (NCDC).
...
Cooperative Societies Credit Support Scheme application process.")
...
1. "This assessment is based on information provided by the client and publicly available guidelines
   for Cooperative Societies Credit Support Scheme. Eligibility is subject to final verification by
   National Cooperative Development Corporation (NCDC)."
2. "Scheme guidelines, eligibility criteria, and benefit amounts for Cooperative Societies Credit Support Scheme
   are subject to change by National Cooperative Development Corporation (NCDC) without notice. We recommend
   verifying current guidelines at https://ncdc.in/index.jsp?page=common-application%3Den before submission."
3. "[Firm Name] is a consulting firm. We are not a government body and have no authority to approve
   or reject any application under Cooperative Societies Credit Support Scheme."
...
"All documents submitted to National Cooperative Development Corporation (NCDC) under Cooperative Societies Credit Support Scheme
