...
| PAN Card of Company | | | Critical |
| Aadhaar/PAN of Promoters/Directors | | | Critical |
| Bank Statement (last 6 months) | | | Critical |
| Audited Financial Statements (if applicable) | | | Optional |
| Business Plan / Project Report | | | Critical |
| Proof of Concept / Prototype Details | | | Critical |
| IPR Details (if any) | | | Optional |
| Team Resumes / CVs | | | Critical |
| Declaration of Startup Status | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: GAIL Pankh Startup Initiative
...
| 02 - Qualified | Eligibility confirmed for GAIL Pankh Startup Initiative | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on [https://www.gailonline.com](https://www.gailonline.com) | Internal review |
| 06 - Submitted | Application filed on [https://www.gailonline.com](https://www.gailonline.com) | Begin follow-up |
| 07 - Under review | With GAIL (Gas Authority of India Limited) | Monitor + respond to queries |
