...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  - Access to IndianOil's technical expertise
  - Infrastructure for pilot testing
  - Mentorship from industry experts
  - Potential for commercial collaboration
  - Visibility through IOCL's innovation network
  - Proof-of-concept validation
  - Scaling opportunities within a corporate ecosystem
...
| Business proposal or pitch deck |  |  | Critical |
...
- Target schemes: Indian Oil Startup Scheme
- Engagement start date:
- Expected application date: (note deadlines from evidence) Rolling basis — no fixed deadline. Applications are accepted year-round.
...
| 02 - Qualified | Eligibility confirmed for Indian Oil Startup Scheme | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://iocl.com/startup | Internal review |
| 06 - Submitted | Application filed on https://iocl.com/startup | Begin follow-up |
| 07 - Under review | With Indian Oil Corporation Limited (IOCL) | Monitor + respond to queries |
