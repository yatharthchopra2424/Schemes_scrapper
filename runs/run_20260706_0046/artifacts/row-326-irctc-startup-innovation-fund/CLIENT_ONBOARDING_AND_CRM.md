...
Registered address, Registered address, Operational address, Website)
...
- What outcome are you seeking? (tick all that apply — list options relevant to THIS scheme's benefit type)
  ...
  - Mentorship from IRCTC experts
  - Access to IRCTC's user base for pilot testing
  - Potential integration of solutions into IRCTC platforms
  - Branding and visibility through IRCTC channels
  - Guidance on regulatory and compliance matters
...
| Technical prototype or MVP details (if applicable) | | | Optional |
| Founder profiles and KYC documents | | | Critical |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: IRCTC Startup Innovation Fund
...
| 02 - Qualified | Eligibility confirmed for IRCTC Startup Innovation Fund | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://irctc.co.in | Internal review |
| 06 - Submitted | Application filed on https://irctc.co.in | Begin follow-up |
| 07 - Under review | With Indian Railway Catering and Tourism Corporation Limited (IRCTC) | Monitor + respond to queries |
