...
|---|---|---|---|
| KYC of applicant and co-applicants | | | Critical |
| Academic Records | | | Critical |
| Proof of admission | | | Critical |
| Entrance Exam Result (if applicable) | | | Critical |
| Statement of cost of study/ Schedule of expenses | | | Critical |
| Income Proof for Salaried Co-applicant/ Guarantor (if applicable) | | | Critical |
| Bank account statement for last 6 months | | | Critical |
| Property Documents (if applicable) | | | Optional |

### Engagement Terms
- Retainer fee: [TO BE FILLED BY CONSULTANT]
- Success fee: [TO BE FILLED BY CONSULTANT]
- Target schemes: Dena Shakti Scheme for Women (Bank of Baroda)
...
| 02 - Qualified | Eligibility confirmed for Dena Shakti Scheme for Women (Bank of Baroda) | Send proposal |
| 03 - Engaged | Retainer signed | Start onboarding |
| 04 - Docs collection | Gathering documents | Chase missing items |
| 05 - In preparation | Drafting application on https://www.bankofbaroda.in/personal-banking/loans/education-loan/skill-loan-scheme | Internal review |
| 06 - Submitted | Application filed on https://www.bankofbaroda.in/personal-banking/loans/education-loan/skill-loan-scheme | Begin follow-up |
| 07 - Under review | With Bank of Baroda | Monitor + respond to queries |
